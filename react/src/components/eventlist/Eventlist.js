...
function EventList(props) {
  return (
    ...
    <Button variant="quaternary" icon="filter_list">Filters</Button>
  </div>
      ...
      <div className={style.eventList}>
          ...
          <div className={style.details}>
            ...
            <div className={style.markets}>
              {sport.marketHeadings.map((heading) => (
                <div key={heading.marketHeadingId} data-num={"X"+heading.marketSelectionHeadings.length}>
        ...
        <div className={style.event}>
          <div className={style.details}>
            ...
            <div className={style.markets}>
              {sport.marketHeadings.map((heading) => (
                <div key={heading.marketHeadingId} data-num={"X"+heading.marketSelectionHeadings.length} className={style.selectionHeadings}>
                  {heading.marketSelectionHeadings.map((selectionHeading) => (
                    <div key={selectionHeading.selectionHeadingId}>{selectionHeading.selectionHeadingName}</div>
                  ))}
                </div>
              ))}
            </div>
